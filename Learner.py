...
class face_learner(object):
    def __init__(self, conf, inference=False):
        ...
        if not inference:
            ...
            self.writer = SummaryWriter('/home/zzg/DeepLearning/InsightFace_Pytorch/work_space/log')
            self.step = 0
...
#            self.agedb_30, self.cfp_fp, self.lfw, self.agedb_30_issame, self.cfp_fp_issame, self.lfw_issame = get_val_data(self.loader.dataset.root.parent)
            self.agedb_30, self.agedb_30_issame = get_val_data('/home/zzg/DeepLearning/InsightFace_Pytorch/data/faces_emore')
        else:
            self.threshold = conf.threshold
    
    def save_state(self, conf, accuracy, to_save_folder=False, extra=None, model_only=False):
        if to_save_folder:
            save_path = '/home/zzg/DeepLearning/InsightFace_Pytorch/work_space/models'
        else:
            save_path = '/home/zzg/DeepLearning/InsightFace_Pytorch/work_space/models'
...
#        self.model.load_state_dict(torch.load(save_path/'model_{}'.format(fixed_str)))
        self.model.load_state_dict(torch.load('work_space/save/model_ir_se50.pth'))
        if not model_only:
